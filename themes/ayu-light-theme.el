...
(custom-theme-set-faces
 'ayu-light
 '(default ((t (:family "Overpass Mono" :foundry "nil" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "gray40" :background "#f5f5f5" :stipple nil :inherit nil))))
